import { defineComponent as R, inject as _, unref as e, openBlock as u, createElementBlock as $, Fragment as O, createBlock as b, withModifiers as I, createCommentVNode as w, useSlots as N, renderSlot as v, normalizeProps as T, guardReactiveProps as B, reactive as Q, withCtx as i, createVNode as m, createTextVNode as A, toDisplayString as D, createElementVNode as E, createSlots as G, shallowRef as Ve, computed as P, watch as W, h as Se, renderList as L, normalizeClass as Oe, ref as z, onMounted as xe, Teleport as he, useModel as Ce, mergeProps as U, toRefs as Ae, useTemplateRef as Pe, withDirectives as Te, vShow as Be } from "vue";
import { B as _e, ap as C, az as le, aN as ae, E as Le, Q as ue, H as Ie, al as je, am as De, an as X, ao as Me, ax as j, aH as Ne, aD as Ee, aB as Ue, aK as de, z as Fe, aO as Ge, aM as Y, af as We, aP as Re, aQ as ze, aR as Ke, aF as pe, aS as qe, aq as He, aT as Je, ay as ce, aa as F, av as Qe, aG as Xe, b as Ye, a9 as Ze, ak as q, aw as et, S as tt, r as lt, t as at, a2 as me, aL as Z, aJ as st, aI as nt, X as ie, a5 as it, Y as ot, aU as oe, aC as rt, aV as ut, aW as dt, aX as H, a1 as pt } from "./index-DDlGN9Dw.js";
import "axios";
const se = /* @__PURE__ */ R({
  __name: "OxAction",
  props: {
  ...
  setup(d) {
    ...
    const s = d;
    return (t, l) => (u(), $(O, null, [
      v(t.$slots, "before", T(B(s))),
      v(t.$slots, "default", T(B(s))),
      v(t.$slots, "after", T(B(s)))
    ], 64));
  }
};
var re;
const vt = /* @__PURE__ */ R({
    ...
    return (f, x) => s.value ? (u(), $(O, { key: 0 }, [
      e(n) && Object.keys(e(n)).length ? (u(), $(O, { key: 0 }, [
        m(st, {
          ...
          default: i(() => [
            v(f.$slots, "tab.default", T(B(c.value)), () => {
              var y, V;
              return [
                m(nt, {
        ...
        m(de, {
          ...
          default: i(() => [
            m(Z, { value: "model" }, {
              default: i(() => [
                v(f.$slots, "window.default", T(B(c.value)))
              ]),
              _: 3
            }),
  ...
  setup(d) {
    const { t: s } = ae(), t = N(), l = F(t, "views.list."), o = F(t, "item."), p = F(t, "views.edit."), r = d, n = _("repos"), a = _("panel"), { value: c } = Ae(a), f = Pe("filters"), x = P(() => it(ie(), r)), y = P(() => ot(
      { ...x.value, value: c },
      { repos: n }
    ));
    P(() => {
    ...
    return (k, g) => (u(), b(ye, {
      ...
      "append-title": i(() => {
        var S;
        return [
          v(k.$slots, "append-title", T(B(M.value))),
          e(a).view.startsWith("list.") ? (u(), b(oe, {
            ...
            default: i(() => [
              v(k.$slots, "nav.list", T(B(M.value))),
              e(f) ? (u(), b(C, {
                key: 0,
            ...
            default: i(() => [
              v(k.$slots, "nav.item", T(B(M.value))),
              e(a).view == "edit" ? (u(), b(rt, { key: 0 }, {
                ...
                default: i(() => [
                  m(ce, null, {
                    default: i(() => [
                      v(k.$slots, "item.actions", T(B(M.value)))
                    ]),
                    _: 3
                  })
                ]),
          ...
          m(ut, {
            ...
            default: i(() => {
              ...
              return [
                ...
                v(k.$slots, "nav.views", T(B(M.value)))
              ];
            }),
            _: 3
          }, 8, ["modelValue"])
      ...
      default: i(() => [
        Te(m(ve, {
          ...
          default: i((S) => [
            v(k.$slots, "list.filters", T(B(S)))
          ]),
          _: 3
        }, 8, ["list", "search"]), [
          [Be, e(a).view.startsWith("list.") && V.value]
        ]),
        m(dt, {
          modelValue: e(a).view,
...
//# sourceMappingURL=index-DdhsyY5y.js.map
