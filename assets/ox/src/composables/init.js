 ...
 */
export function init({ App = null, el = '#app', onLoad = true, ...options } = {}) {
    function initApp() {
    ...
    return new Promise((resolve) => {
        if (onLoad)
            return window.addEventListener('load', () => resolve(initApp()));
        resolve(initApp());
    });
}
/**
 ...
 */
export function createVuetify({ components = {}, defaults = {}, ...opts }) {
    opts.components = {
        ...vendorComponents,
        ...components
    };
