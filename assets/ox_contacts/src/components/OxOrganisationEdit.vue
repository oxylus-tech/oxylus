                ...
                <template #text>
                    <v-form v-model="editor.valid">
                        ...
                        <v-text-field :label="t('fields.vat')"
                            v-model="editor.value.vat" :rules="[optionalRule(vatRule)]">
                            <template #details>
                                <ox-field-details :errors="editor.errors?.vat"/>
                            </template>
                        </v-text-field>
                        <v-text-field :label="t('fields.company_form')"
                            v-model="editor.value.company_form">
                            <template #details>
                                <ox-field-details :errors="editor.errors?.company_form"/>
                            </template>
                        </v-text-field>
                        ...
                        <v-text-field :label="t('fields.country')"
